...
def evaluar(i,j):
	...
	estado=valores[i][j]
	if i==0:
		vecindad.append(valores[tam-1][j])#superior
		vecindad.append(valores[i+1][j])#inferior
		if j==0:
			vecindad.append(valores[tam-1][tam-1])#superior izquierdo
			vecindad.append(valores[tam-1][j+1])#superior derecho
			vecindad.append(valores[i][tam-1])#izquierdo
			vecindad.append(valores[i][j+1])#derecho
			vecindad.append(valores[i+1][tam-1])#inferior izquierdo
			vecindad.append(valores[i+1][j+1])#inferior derecho
		elif j==tam-1:
			vecindad.append(valores[tam-1][j-1])#superior izquierdo
			vecindad.append(valores[tam-1][0])#superior derecho
			vecindad.append(valores[i][j-1])#izquierdo
			vecindad.append(valores[i][0])#derecho
			vecindad.append(valores[i+1][j-1])#inferior izquierdo
			vecindad.append(valores[i+1][0])#inferior derecho
		else:
			vecindad.append(valores[tam-1][j-1])#superior izquierdo
			vecindad.append(valores[tam-1][j+1])#superior derecho
			vecindad.append(valores[i][j-1])#izquierdo
		...
		vecindad.append(valores[i-1][j])#superior
		vecindad.append(valores[0][j])#inferior
		if j==0:
			vecindad.append(valores[i-1][tam-1])#superior izquierdo
			vecindad.append(valores[i-1][j+1])#superior derecho
			vecindad.append(valores[i][tam-1])#izquierdo
			vecindad.append(valores[i][j+1])#derecho
			vecindad.append(valores[0][tam-1])#inferior izquierdo
			vecindad.append(valores[0][j+1])#inferior derecho
		elif j==tam-1:
			vecindad.append(valores[i-1][j-1])#superior izquierdo
			vecindad.append(valores[i-1][0])#superior derecho
			vecindad.append(valores[i][j-1])#izquierdo
			vecindad.append(valores[i][0])#derecho
			vecindad.append(valores[0][j-1])#inferior izquierdo
			vecindad.append(valores[0][0])#inferior derecho
		else:
			vecindad.append(valores[i-1][j-1])#superior izquierdo
			vecindad.append(valores[i-1][j+1])#superior derecho
			vecindad.append(valores[i][j-1])#izquierdo
